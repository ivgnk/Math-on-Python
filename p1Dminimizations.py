...
def plot_func(n:int, minf:types.FunctionType, name_:str)->None:
    global fff;  fff = minf
...
if __name__ == "__main__":
   ...
   # for i in range(len(lst_func)):
    for i in range(1):
        nnn1 = lst_func[i][0]
        minf__1 = lst_func[i][1]
        name1 = lst_func[i][2]
        all_minimizations_testing(n = nnn1, minx=-nnn1, maxx=nnn1, minf = minf__1, name_= name1)