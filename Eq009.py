'''
https://www.youtube.com/watch?v=YP3umMmQ6Lw
1d function, 1d minimization
math.sqrt(x*math.sqrt(x*math.sqrt(x)))-2
...
def minf(x):
    return math.sqrt(x*math.sqrt(x*math.sqrt(x)))-2

def minf2(x):
    d = abs(math.sqrt(x*math.sqrt(x*math.sqrt(x)))-2)
    # print(x,d)
    return d
